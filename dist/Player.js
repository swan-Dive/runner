...
export class Player {
    ...
    drawExplosion(ctx) {
        ctx.drawImage(this.state.images.shrink, SHRINK_SPRITE_X_MAPPER[this.state.shrinkFrameIndex], 0, 480, 480, this.getX() - 20, this.getY() - 12, this.getWidth() + 40, this.getHeight() + 40);
    }
    draw(ctx) {
        if (!ctx) {
